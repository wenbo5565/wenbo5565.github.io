...
<center>
![Figure is from Prof. Hsuan-Tien Lin's Slides on ML Techniques](/img/svm/svm1.png){width=60%}
...
<center>
![Figure is from Prof. Hsuan-Tien Lin's Slides on ML Techniques](/img/svm/svm2.png){width=50%}
