...
Backpropagation is being widely used in neural networks to enable computers learn weights in each layer of a neural network. From mathematics perspective, it is just an implementation of chain rule in Calculus. However, it enables the computer to calculate derivative of complex functions (e.g. deep neural networks) without explicitly writing down the mathematical formulas.
...
<center>
![Computational Graph of BackPropogation](/img/backprop/blogimage/backprop.png)
</center>
